...
class BlocFlashSale extends Bloc<EventBloc, StateBloc> {
  BlocFlashSale() : super(StateBloc());
  ...
  Stream<StateBloc> mapEventToState(EventBloc event) async* {
    if (event is GetData) {
      ...
      try {
        ...
        var res = await Api.getAsync(endPoint: ApiPath.flash+event.param,isToken: false);
